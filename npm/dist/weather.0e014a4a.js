...
})({"lB9bA":[function(require,module,exports) {
...
parcelHelpers.export(exports, "favouriteCities", ()=>favouriteCities);
parcelHelpers.export(exports, "svg", ()=>svg);
var _dateFns = require("date-fns");
var _uiElementsJs = require("./uiElements.js");
var _changingTabsJs = require("./changingTabs.js");
var _apiRequestJs = require("./apiRequest.js");
var _jsCookie = require("js-cookie");
var _jsCookieDefault = parcelHelpers.interopDefault(_jsCookie);
"use script";
const loc = document.querySelector(".locations h2");
loc.innerHTML = (0, _dateFns.format)(new Date(), "Pp");
(0, _uiElementsJs.TABS).weatherButtons.addEventListener("click", function(event) {
    const clickButton = event.target;
    if ((0, _changingTabsJs.checkClickTabs)(clickButton)) (0, _changingTabsJs.changeTabs)(clickButton);
});
const storage = [];
...
const obj = {
    currentCity: (0, _jsCookieDefault.default).get("name")
};
(0, _apiRequestJs.cityTemp)(obj.currentCity);
(0, _uiElementsJs.ELEMENTS).searchCity.addEventListener("click", function(e) {
    e.preventDefault();
    (0, _apiRequestJs.cityTemp)(obj.currentCity);
});
...
like.addEventListener("click", function() {
    if (favouriteCities.size === 0) {
        pushCity((0, _uiElementsJs.ELEMENTS).city.textContent);
    ...
    if (fav) {
        console.log("gg");
        deleteCity((0, _uiElementsJs.ELEMENTS).city.textContent);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6zmqo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gBj1p":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "checkClickTabs", ()=>checkClickTabs);
parcelHelpers.export(exports, "changeTabs", ()=>changeTabs);
var _uiElementsJs = require("./uiElements.js");
"use script";
(0, _uiElementsJs.TABS).weatherButtons.addEventListener("click", function(event) {
    const clickButton = event.target;
...
function changeTabs(clickButton) {
    const activeButton = (0, _uiElementsJs.TABS).weatherButtons.querySelector(".weather__button.-active");
    activeButton.classList.remove("-active");
    clickButton.classList.add("-active");
    const indexClickButton = (0, _uiElementsJs.TABS).weatherButtonAll.findIndex((item)=>item === clickButton);
    const activeTab = (0, _uiElementsJs.TABS).weatherTabs.querySelector(".weather__tab.-active");
    activeTab.classList.remove("-active");
    const newActiveTab = (0, _uiElementsJs.TABS).weatherTabAll[indexClickButton];
    newActiveTab.classList.add("-active");
}

},{"./uiElements.js":"6zmqo","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gsGZs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "cityTemp", ()=>cityTemp);
var _uiElementsJs = require("./uiElements.js");
...
async function cityTemp(city) {
    ...
    try {
        ...
        (0, _uiElementsJs.ELEMENTS).listDetails.firstElementChild.textContent = `Temperature: ${Math.floor(temp - 273)}°`;
        (0, _uiElementsJs.ELEMENTS).listDetails.children[1].textContent = `Feels like: ${Math.floor(feelsLike - 273)}°`;
...
},{}]},["lB9bA","bRRRP"], "bRRRP", "parcelRequirebc7a")

//# sourceMappingURL=weather.0e014a4a.js.map
