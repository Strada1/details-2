...
var _elementJs = require("./js/element.js");
var _timerJs = require("./js/timer.js");
(0, _elementJs.ELEMENT).CALENDAR.addEventListener("submit", (event)=>{
    event.preventDefault();
    (0, _timerJs.timer)();
});

},{"./js/element.js":"kPI0O","./js/timer.js":"b7mcv"}],"kPI0O":[function(require,module,exports) {
...
function timer() {
    const timer = new Date((0, _elementJs.ELEMENT).INPUT.value);
    console.log(timer);
    const dateNow = new Date();
    console.log(dateNow);
    const result = (0, _dateFns.formatDistance)(timer, dateNow);
    console.log(result);
}

},{"./element.js":"kPI0O","date-fns":"9yHCA","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9yHCA":[function(require,module,exports) {
