...
if ((0, _storageJs.storage).getDateCalendar()) {
    (0, _elementJs.ELEMENT).INPUT.value = (0, _storageJs.storage).getDateCalendar();
    setInterval((0, _timerJs.timer), 1000);
}
if ((0, _storageJs.storage).getTimeCalendar()) {
    (0, _elementJs.ELEMENT).INPUT_TIME.value = (0, _storageJs.storage).getTimeCalendar();
    setInterval((0, _timerJs.timer), 1000);
}
(0, _elementJs.ELEMENT).CALENDAR.addEventListener("submit", (event)=>{
    event.preventDefault();
    const date = (0, _elementJs.ELEMENT).INPUT.value;
    const time = (0, _elementJs.ELEMENT).INPUT_TIME.value;
    (0, _storageJs.storage).saveDate(date, time);
    setInterval((0, _timerJs.timer), 1000);
});

},{"./element.js":"kPI0O","./timer.js":"b7mcv","./storage.js":"j1l1C"}],"kPI0O":[function(require,module,exports) {
...
const ELEMENT = {
    ...
    INPUT_TIME: document.querySelector(".time-input"),
...
var _storageJs = require("./storage.js");
function timer() {
    const date = new Date((0, _storageJs.storage).getDateCalendar());
    const time = (0, _storageJs.storage).getTimeCalendar();
    const hour = time.split(":")[0];
    const minute = time.split(":")[1];
    const getDate = (0, _dateFns.add)(date, {
        hours: hour,
        minutes: minute
    });
    const resultYears = Math.floor(parseInt((0, _dateFns.formatDistanceToNowStrict)(getDate, {
        unit: "day"
    })) / 365);
    const resultDays = Math.floor(parseInt((0, _dateFns.formatDistanceToNowStrict)(getDate, {
        unit: "day"
    })) % 365);
    const resultHours = Math.floor(parseInt((0, _dateFns.formatDistanceToNowStrict)(getDate, {
        unit: "minute"
    })) / 60) % 24;
    const resultMinutes = Math.floor(parseInt((0, _dateFns.formatDistanceToNowStrict)(getDate, {
        unit: "second"
    })) / 60 % 60);
    const resultSeconds = parseInt((0, _dateFns.formatDistanceToNowStrict)(getDate, {
        unit: "second"
    })) % 60;
    const TIMER = {
        YEARS: resultYears,
    ...
    (0, _renderJs.render)(TIMER);
}

},{"date-fns":"9yHCA","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./render.js":"9k0mC","./storage.js":"j1l1C"}],"9yHCA":[function(require,module,exports) {
...
},{"../formatDistanceStrict/index.js":"gN5ZD","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"k3IR8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../toDate/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
function render(TIMER) {
    (0, _elementJs.ELEMENT).YEARS.textContent = TIMER.YEARS;
    (0, _elementJs.ELEMENT).DAYS.textContent = TIMER.DAYS;
    (0, _elementJs.ELEMENT).HOURS.textContent = TIMER.HOURS;
    (0, _elementJs.ELEMENT).MINUTES.textContent = TIMER.MINUTES;
    (0, _elementJs.ELEMENT).SECONDS.textContent = TIMER.SECONDS;
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./element.js":"kPI0O"}],"j1l1C":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
