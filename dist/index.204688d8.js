...
})({"fJ5HR":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "f8fd82c6204688d8";
"use strict";
...
},{}],"l6uRW":[function(require,module,exports) {
...
let isPageNow = true;
const fetchData = async (searchValueInput)=>{
    try {
        const data = await fetch(`${URL}?q=${searchValueInput ? searchValueInput : inputSearch.value}&appid=${API_KEY}`);
        if (data.status !== 200) throw new (0, _errorJs.HttpError)(data.statusText);
        const response = await data.json();
        if (isPageNow) (0, _renderJs.renderNowPage)(response);
        else (0, _renderJs.renderDetailsPage)(response);
    } catch (e) {
        alert(e.message);
    }
};
...
(0, _renderJs.addFromCookies)();
detailsButton.addEventListener("click", ()=>{
    detailsButton.classList.add("active");
    nowButton.classList.remove("active");
    isPageNow = false;
    if (0, _renderJs.mainText) fetchData((0, _renderJs.mainText));
});
nowButton.addEventListener("click", ()=>{
    detailsButton.classList.remove("active");
    nowButton.classList.add("active");
    isPageNow = true;
    console.log((0, _renderJs.mainText));
    fetchData((0, _renderJs.mainText));
});

},{"./error.js":"bD4hF","./render.js":"bDjPl","@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"bD4hF":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"bDjPl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "mainText", ()=>mainText);
parcelHelpers.export(exports, "renderDetailsPage", ()=>renderDetailsPage);
parcelHelpers.export(exports, "renderNowPage", ()=>renderNowPage);
parcelHelpers.export(exports, "addFromCookies", ()=>addFromCookies);
var _jsCookie = require("js-cookie");
var _jsCookieDefault = parcelHelpers.interopDefault(_jsCookie);
var _getCorrectValueJs = require("./getCorrectValue.js");
...
const cookiesCities = JSON.parse((0, _jsCookieDefault.default).get("cities"));
let favCities = [];
let mainText;
function renderDetailsPage(weatherObject) {
    ...
    tempretature.textContent = `Temperature: ${(0, _getCorrectValueJs.getCurrentWeather)(weatherObject.main.temp)}`;
    feelsLike.textContent = `Feels like: ${(0, _getCorrectValueJs.getCurrentWeather)(weatherObject.main.feels_like)} `;
    weather.textContent = `Weather: ${weatherObject.weather[0].main}`;
    sunrise.textContent = `Sunrise: ${(0, _getCorrectValueJs.getCorrectTime)(weatherObject.sys.sunrise)}`;
    sunset.textContent = `Sunset: ${(0, _getCorrectValueJs.getCorrectTime)(weatherObject.sys.sunset)}`;
...
function renderNowPage(dataObject) {
    ...
    if (favCities.some((city)=>city.toLowerCase() === footerSpan.textContent.toLowerCase())) iconImage.classList.add("liked");
    iconFooter.addEventListener("click", ()=>{
        const spanCity = document.createElement("span");
        if (iconImage.classList.contains("liked")) {
            iconImage.classList.remove("liked");
            let newFavCities = favCities.filter((city)=>city !== footerSpan.textContent);
            favCities = [
                ...newFavCities
            ];
            console.log(favCities);
            localStorage.setItem("citys", JSON.stringify(favCities));
            (0, _jsCookieDefault.default).set("cities", favCities);
            ...
            favCities.map((city)=>{
                ...
                span.addEventListener("click", (e)=>{
                    if (city === e.target.textContent) (0, _mainJs.fetchData)(city);
                });
            });
        } else {
            iconImage.classList.add("liked");
            const isCityInArray = favCities.some((city)=>city === footerSpan.textContent);
            console.log(isCityInArray, favCities);
            if (!isCityInArray) {
                favCities.push(footerSpan.textContent);
                console.log(favCities);
                localStorage.setItem("citys", JSON.stringify(favCities));
                (0, _jsCookieDefault.default).set("cities", JSON.stringify(favCities));
                console.log((0, _jsCookieDefault.default).get("cities"));
                favCities.map((city)=>{
...
},{"js-cookie":"hbyNh","./getCorrectValue.js":"k5QaJ","./main.js":"l6uRW","@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"hbyNh":[function(require,module,exports) {
...
},{}],"k5QaJ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getCorrectTime", ()=>getCorrectTime);
parcelHelpers.export(exports, "getCurrentWeather", ()=>getCurrentWeather);
var _dateFns = require("date-fns");
function getCorrectTime(time) {
    const date = new Date(time * 1000);
    const formattedTime = (0, _dateFns.format)(date, "H:mm:ss");
    return formattedTime;
}
function getCurrentWeather(number) {
    return Math.floor(Number(number) - 273);
}

},{"date-fns":"f2TG1","@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"f2TG1":[function(require,module,exports) {
...
},{"../_lib/toInteger/index.js":"5Guea","../toDate/index.js":"bBLeR","../_lib/requiredArgs/index.js":"fBgwY","@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"5Guea":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"bBLeR":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../_lib/requiredArgs/index.js":"fBgwY","@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"fBgwY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"cKFpH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../isValid/index.js":"cdjHc","../subMilliseconds/index.js":"lKed6","../toDate/index.js":"bBLeR","../_lib/format/formatters/index.js":"efnOW","../_lib/format/longFormatters/index.js":"42INg","../_lib/getTimezoneOffsetInMilliseconds/index.js":"drGYJ","../_lib/protectedTokens/index.js":"8ETBE","../_lib/toInteger/index.js":"5Guea","../_lib/requiredArgs/index.js":"fBgwY","../_lib/defaultOptions/index.js":"kKCHT","../_lib/defaultLocale/index.js":"fLrmp","@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"cdjHc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../isDate/index.js":"kja10","../toDate/index.js":"bBLeR","../_lib/requiredArgs/index.js":"fBgwY","@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"kja10":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../_lib/requiredArgs/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../_lib/requiredArgs/index.js":"fBgwY","@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"lKed6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../addMilliseconds/index.js":"anErQ","../_lib/requiredArgs/index.js":"fBgwY","../_lib/toInteger/index.js":"5Guea","@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"efnOW":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../../../_lib/getUTCDayOfYear/index.js":"gBsRh","../../../_lib/getUTCISOWeek/index.js":"lXuNJ","../../../_lib/getUTCISOWeekYear/index.js":"1Ayl4","../../../_lib/getUTCWeek/index.js":"cSH7g","../../../_lib/getUTCWeekYear/index.js":"9yEPh","../../addLeadingZeros/index.js":"Z5B3F","../lightFormatters/index.js":"6RaxL","@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"gBsRh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../../toDate/index.js":"bBLeR","../requiredArgs/index.js":"fBgwY","@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"lXuNJ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../../toDate/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../../toDate/index.js":"bBLeR","../startOfUTCISOWeek/index.js":"jtR3B","../startOfUTCISOWeekYear/index.js":"lH5Oz","../requiredArgs/index.js":"fBgwY","@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"jtR3B":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../../toDate/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../../toDate/index.js":"bBLeR","../requiredArgs/index.js":"fBgwY","@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"lH5Oz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../getUTCISOWeekYear/index.js":"1Ayl4","../startOfUTCISOWeek/index.js":"jtR3B","../requiredArgs/index.js":"fBgwY","@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"1Ayl4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../../toDate/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../../toDate/index.js":"bBLeR","../requiredArgs/index.js":"fBgwY","../startOfUTCISOWeek/index.js":"jtR3B","@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"cSH7g":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../../toDate/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../../toDate/index.js":"bBLeR","../startOfUTCWeek/index.js":"icP5t","../startOfUTCWeekYear/index.js":"dcm25","../requiredArgs/index.js":"fBgwY","@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"icP5t":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../../toDate/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../../toDate/index.js":"bBLeR","../requiredArgs/index.js":"fBgwY","../toInteger/index.js":"5Guea","../defaultOptions/index.js":"kKCHT","@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"kKCHT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"dcm25":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../getUTCWeekYear/index.js":"9yEPh","../requiredArgs/index.js":"fBgwY","../startOfUTCWeek/index.js":"icP5t","../toInteger/index.js":"5Guea","../defaultOptions/index.js":"kKCHT","@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"9yEPh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../../toDate/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
},{"../../toDate/index.js":"bBLeR","../requiredArgs/index.js":"fBgwY","../startOfUTCWeek/index.js":"icP5t","../toInteger/index.js":"5Guea","../defaultOptions/index.js":"kKCHT","@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"Z5B3F":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"6RaxL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../../addLeadingZeros/index.js":"Z5B3F","@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"42INg":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"drGYJ":[function(require,module,exports) {
/**
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"8ETBE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"fLrmp":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../../locale/en-US/index.js":"fDvxM","@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"fDvxM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./_lib/formatDistance/index.js":"2xY8v","./_lib/formatLong/index.js":"gyL07","./_lib/formatRelative/index.js":"67ZtK","./_lib/localize/index.js":"943sZ","./_lib/match/index.js":"eJWAG","@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"2xY8v":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"gyL07":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../../../_lib/buildFormatLongFn/index.js":"18pgV","@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"18pgV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"67ZtK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"943sZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../../../_lib/buildLocalizeFn/index.js":"gRkG7","@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"gRkG7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"eJWAG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../../../_lib/buildMatchFn/index.js":"9xoBo","../../../_lib/buildMatchPatternFn/index.js":"knv98","@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"9xoBo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"knv98":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}],"98NHN":[function(require,module,exports) {
/**
 * Days in 1 week.
 *
 * @name daysInWeek
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"hB1uZ"}]},["fJ5HR","l6uRW"], "l6uRW", "parcelRequiree9ea")

//# sourceMappingURL=index.204688d8.js.map
