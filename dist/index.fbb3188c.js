...
(0, _uiJs.UI_ELEMENTS).NOW_BTN_LIKE.addEventListener("click", ()=>{
    const cityName = (0, _uiJs.UI_ELEMENTS).NOW_BTN_LIKE.previousElementSibling.textContent;
...
function addCityFavorite(cityName) {
    ...
    if (isValid) {
        ...
        (0, _storageJs.addStorageFavoriteCities)(favoriteCityList);
        renderFavoriteCity();
    }
}
...
function renderFavoriteCity() {
    (0, _uiJs.UI_ELEMENTS).FAVORITE_LIST.textContent = "";
    favoriteCityList = (0, _storageJs.getStorageFavoriteCities)();
    favoriteCityList.forEach((element)=>{
        ...
        if (isValid) (0, _uiJs.UI_ELEMENTS).NOW_BTN_LIKE.classList.add("now__sities-btn--like");
        item.append(button);
        (0, _uiJs.UI_ELEMENTS).FAVORITE_LIST.append(item);
        item.addEventListener("click", ()=>{
            getWeather(element);
            (0, _storageJs.addStorageCurrentCity)(element);
        });
    });
}
function checkCityFavorite(cityName) {
    const isValid = favoriteCityList.includes(cityName);
    if (!isValid) (0, _uiJs.UI_ELEMENTS).NOW_BTN_LIKE.classList.remove("now__sities-btn--like");
    else (0, _uiJs.UI_ELEMENTS).NOW_BTN_LIKE.classList.add("now__sities-btn--like");
}
(0, _uiJs.UI_ELEMENTS).FORM.addEventListener("submit", (event)=>{
    event.preventDefault();
    const cityName = (0, _uiJs.UI_ELEMENTS).INPUT_FORM.value;
    (0, _storageJs.addStorageCurrentCity)(cityName);
    getWeather(cityName);
    event.target.reset();
});
async function getWeather(cityName) {
    ...
    try {
        ...
        (0, _uiJs.showWeatherNow)(data);
        (0, _uiJs.showWeatherDetails)(data);
    } catch (error) {
        alert(error);
    }
}
...
getWeather();
(0, _storageJs.getStorageFavoriteCities)();
renderFavoriteCity();
console.log((0, _dateFns.format)(new Date(), "'Today is a' eeee"));

},{"date-fns":"9yHCA","./ui.js":"1hWqh","./storage.js":"j1l1C","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9yHCA":[function(require,module,exports) {
...
parcelHelpers.export(exports, "showWeatherNow", ()=>showWeatherNow);
parcelHelpers.export(exports, "showWeatherDetails", ()=>showWeatherDetails);
...
function showWeatherDetails(data) {
    ...
    UI_ELEMENTS.DETAILS_SUNRISE.textContent = (0, _mainJs.convertTime)(data.sys.sunrise);
    UI_ELEMENTS.DETAILS_SUNSET.textContent = (0, _mainJs.convertTime)(data.sys.sunset);
}

},{"./main.js":"bDbGG","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"j1l1C":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "addStorageCurrentCity", ()=>addStorageCurrentCity);
parcelHelpers.export(exports, "getStorageCurrentCity", ()=>getStorageCurrentCity);
...
function getStorageFavoriteCities() {
